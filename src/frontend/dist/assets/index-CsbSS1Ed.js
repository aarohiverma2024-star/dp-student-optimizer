...
function knapsackDP(n, hours, marks, capacity) {
  const dp = Array.from(
    { length: n + 1 },
    () => new Array(capacity + 1).fill(0)
  );
  for (let i = 1; i <= n; i++) {
    for (let w2 = 0; w2 <= capacity; w2++) {
      dp[i][w2] = dp[i - 1][w2];
      if (hours[i - 1] <= w2) {
        dp[i][w2] = Math.max(
          dp[i][w2],
          dp[i - 1][w2 - hours[i - 1]] + marks[i - 1]
        );
      }
    }
  }
...
function matrixChainDP(dims) {
  ...
  for (let len = 2; len <= n; len++) {
    for (let si = 0; si <= n - len; si++) {
      ...
      for (let k = si; k < sj; k++) {
        const cost = dp[si][k] + dp[k + 1][sj] + dims[si] * dims[k + 1] * dims[sj + 1];
        if (cost < dp[si][sj]) {
          dp[si][sj] = cost;
        }
      }
  ...
  const rows = dp.map((row, ri) => ({
    ...
    cells: row.map((val, ci) => {
      ...
      return {
        key: `kc-${ri}-${ci}`,
        value: val,
        className: isOptimal ? "dp-cell-optimal" : val > 0 ? "dp-cell-computed" : "bg-card text-muted-foreground"
      };
    })
  }));
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "text-xs border-collapse", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "dp-cell-header px-2 py-1.5 border sticky left-0 z-10 min-w-[60px]", children: "Subj\\Time" }),
      headerCols.map((col) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "th",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: rows.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "dp-cell-header px-2 py-1.5 border sticky left-0 z-10", children: row.label }),
      row.cells.map((cell) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "td",
        {
...
function MatrixChainDPTable({ dp }) {
  const n = dp.length;
  ...
  const rows = dp.map((row, ri) => ({
    ...
    cells: row.map((val, ci) => ({
      key: `mc-${ri + 1}-${ci + 1}`,
      value: val,
      className: ri === 0 && ci === n - 1 ? "dp-cell-optimal" : val > 0 && val !== Number.POSITIVE_INFINITY ? "dp-cell-computed" : "bg-card text-muted-foreground"
    }))
  }));
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "text-xs border-collapse", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "dp-cell-header px-2 py-1.5 border min-w-[50px]", children: "i \\ j" }),
      headerCols.map((label) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "th",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: rows.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "dp-cell-header px-2 py-1.5 border", children: row.label }),
      row.cells.map((cell) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "td",
        {
          className: `px-2 py-1.5 border text-center ${cell.className}`,
          children: cell.value === Number.POSITIVE_INFINITY ? "—" : cell.value.toLocaleString()
        },
        cell.key
      ))
    ] }, row.key)) })
    ...
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 py-3 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg text-primary", children: "📚 DP Optimizer" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-1", children: sections.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => scrollTo(s),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-5 flex flex-col gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden border-t bg-card px-4 py-3 flex flex-col gap-1", children: sections.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => scrollTo(s),
...
function HeroSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(135deg, oklch(0.95 0.04 260) 0%, oklch(0.96 0.03 280) 50%, oklch(0.94 0.04 310) 100%)"
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 py-20 md:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-10 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-primary/10 text-primary border-primary/20 hover:bg-primary/20", children: "Dynamic Programming" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl md:text-5xl font-extrabold leading-tight text-foreground mb-4", children: [
            "Student Life ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Optimization" }),
            " ",
            "System"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-lg mb-8 leading-relaxed", children: [
            "Ever felt overwhelmed deciding which subjects to study, or if your notes are similar? Dynamic Programming turns complex life decisions into ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "step-by-step math" }),
            " — solve it once, reuse the answer forever."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                onClick: () => {
                  var _a2;
                  return (_a2 = document.getElementById("demo")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
                },
...
function AboutSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-3 bg-secondary/20 text-secondary-foreground border-secondary/20", children: "About DP" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl font-bold mb-4", children: "What is Dynamic Programming?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-lg max-w-2xl mx-auto", children: [
        "Think of it like a smart student who writes answers on a sticky note instead of solving the same problem twice. That's exactly what DP does — ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "solve once, reuse many times." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-5", children: dpConcepts.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "card-hover border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl mb-3", children: c.icon }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-base mb-2", children: c.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: c.desc })
    ] }) }, c.title)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 p-6 rounded-xl bg-primary/5 border border-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-foreground leading-relaxed", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "🧠 Real analogy:" }),
      ` Imagine you're asked "What's 12×15?" five times during an exam. Instead of multiplying each time, you write`,
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "bg-primary/10 px-1 rounded text-primary", children: "180" }),
      " ",
      "on your rough sheet and reuse it. That's memoization! DP applies this idea to problems with",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "hundreds of overlapping sub-calculations" }),
      "."
    ] }) })
  ] }) });
}
const algorithmCards = [
  {
    ...
    realUse: "Pick the best subjects to study given a time limit to maximize marks.",
    input: "Number of subjects, hours each takes, marks each gives, total study hours",
  ...
  },
  {
    ...
    realUse: "Check how similar two sets of notes are — useful for plagiarism detection.",
  ...
  },
  {
    ...
    realUse: "Find the optimal order to study subjects to minimize total mental effort.",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-3 bg-accent/10 text-accent border-accent/20", children: "3 Algorithms" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl font-bold mb-4", children: "Real-Life DP Applications" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-xl mx-auto", children: "Three everyday student problems, each solved elegantly with Dynamic Programming." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6", children: algorithmCards.map((alg) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Card,
          {
            className: `card-hover border-2 ${alg.borderClass} ${alg.bgClass}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl mb-2", children: alg.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: `w-fit text-xs mb-2 ${alg.badgeClass}`, children: alg.subtitle }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: `font-display text-lg ${alg.colorClass}`, children: alg.title })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3 text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Real-life use:" }),
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: alg.realUse })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Input:" }),
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: alg.input })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Output:" }),
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: alg.output })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Time:" }),
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "code",
                    {
                      className: `px-1.5 py-0.5 rounded text-xs ${alg.bgClass} ${alg.colorClass} border ${alg.borderClass}`,
                      children: alg.complexity
                    }
                  )
                ] })
              ] })
...
function KnapsackDemo() {
  const [numSubjects, setNumSubjects] = reactExports.useState("4");
  const [hoursInput, setHoursInput] = reactExports.useState("2,3,4,5");
  const [marksInput, setMarksInput] = reactExports.useState("10,15,20,25");
  const [capacityInput, setCapacityInput] = reactExports.useState("8");
  ...
  const calculate = () => {
    ...
    const hours = hoursInput.split(",").map((x) => Number.parseInt(x.trim(), 10));
    const marks = marksInput.split(",").map((x) => Number.parseInt(x.trim(), 10));
    ...
    if (hours.some((v) => !isValidInt(v)) || marks.some((v) => !isValidInt(v))) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium mb-1.5 block", children: "Number of Subjects" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            type: "number",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium mb-1.5 block", children: "Total Study Hours Available" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            type: "number",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium mb-1.5 block", children: "Hours per Subject (comma-separated)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            value: hoursInput,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium mb-1.5 block", children: "Marks per Subject (comma-separated)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            value: marksInput,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        ...
        children: "🎒 Calculate Max Marks"
      }
    ),
    result && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-primary/20 bg-primary/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-2xl font-display font-bold text-primary mb-1", children: [
          "🏆 Maximum Marks: ",
          result.maxMarks
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mb-3", children: [
          "With ",
          result.capacity,
          " hours available, you can score up to",
          " ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: result.selected.map(
          (sel, idx) => sel ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Badge,
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-sm mb-2", children: "📊 DP Table Visualization (rows = subjects, cols = hours)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 mb-2 text-xs flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-4 h-4 rounded border bg-card border-border" }),
            "Zero / Initial"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-4 h-4 rounded border dp-cell-computed" }),
            "Computed value"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-4 h-4 rounded border dp-cell-optimal" }),
            "Optimal (bottom-right)"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto rounded-lg border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(KnapsackDPTable, { dp: result.dp, capacity: result.capacity }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "💡 Each cell dp[i][w] = best marks using first i subjects with w hours. Values are reused from previous rows — no recomputation!" })
      ] })
    ] })
  ] });
}
function LcsDemo() {
  const [textA, setTextA] = reactExports.useState("STUDY MATH PHYSICS CHEMISTRY");
  const [textB, setTextB] = reactExports.useState("STUDY BIOLOGY PHYSICS ENGLISH");
  const [result, setResult] = reactExports.useState(null);
  const [error, setError] = reactExports.useState("");
  const calculate = () => {
    setError("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium mb-1.5 block", children: "Notes Text A" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium mb-1.5 block", children: "Notes Text B" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            className: "w-full min-h-[100px] px-3 py-2 rounded-md border bg-background text-sm resize-y focus:outline-none focus:ring-2 focus:ring-ring",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        ...
        children: "📝 Check Similarity"
      }
    ),
    result && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-in fade-in slide-in-from-bottom-2 duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-secondary/20 bg-secondary/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-4 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-2xl font-display font-bold text-secondary", children: [
          result.similarity,
          "% Similar"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Badge,
          {
            className: result.similarity >= 70 ? "bg-destructive/15 text-destructive border-destructive/30" : result.similarity >= 40 ? "bg-secondary/15 text-secondary-foreground border-secondary/30" : "bg-muted text-muted-foreground",
            children: result.similarity >= 70 ? "⚠️ High Similarity" : result.similarity >= 40 ? "🔍 Moderate Similarity" : "✅ Low Similarity"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium mb-1", children: "Longest Common Subsequence:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "text-sm bg-secondary/10 text-secondary-foreground px-2 py-1 rounded border border-secondary/20 block break-all", children: result.lcsStr || "(no common subsequence)" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
        "💡 LCS length = ",
        result.lcsStr.length,
        " characters. Similarity = LCS length ÷ max(|A|, |B|) × 100. The DP table compares every character pair — avoiding redundant checks via stored results."
      ] })
    ] }) }) })
  ] });
}
function MatrixChainDemo() {
  const [nInput, setNInput] = reactExports.useState("4");
  const [dimsInput, setDimsInput] = reactExports.useState("10,30,5,60,20");
  const [result, setResult] = reactExports.useState(null);
  const [error, setError] = reactExports.useState("");
  const calculate = () => {
    setError("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium mb-1.5 block", children: "Number of Subjects (2–8)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            type: "number",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-sm font-medium mb-1.5 block", children: [
          "Effort/Dimension Array (",
          Number.parseInt(nInput, 10) + 1 || 5,
          " ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "💡 Think of each subject as a matrix. Dimensions represent complexity. We find the optimal study order to minimize total mental effort (scalar multiplications)." }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "p",
      {
        className: "text-sm text-destructive bg-destructive/10 px-3 py-2 rounded-md",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        ...
        children: "📐 Calculate Minimum Effort"
      }
    ),
    result && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-in fade-in slide-in-from-bottom-2 duration-300 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-accent/20 bg-accent/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-4 space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-2xl font-display font-bold text-accent", children: [
          "⚡ Minimum Effort: ",
          result.minCost.toLocaleString(),
          " units"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
          "By choosing the optimal study order, total mental effort is reduced to",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { children: [
            result.minCost.toLocaleString(),
            " units"
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-sm mb-2", children: "📊 DP Cost Table (dp[i][j] = min effort to study subjects i to j)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto rounded-lg border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MatrixChainDPTable, { dp: result.dp }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "💡 Green = overall min cost. Blue = reused intermediate values. Each cell builds on previously computed sub-ranges — no repeated work!" })
      ] })
    ] })
  ] });
}
function DemoSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "demo", className: "py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-3 bg-primary/10 text-primary border-primary/20", children: "Interactive Demo" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl font-bold mb-4", children: "Try the Algorithms" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-xl mx-auto", children: "Enter real values and see Dynamic Programming solve your student problems live!" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "knapsack", className: "w-full", "data-ocid": "demo-tabs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "w-full justify-start h-auto flex-wrap gap-1 mb-6 bg-muted/50 p-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          TabsTrigger,
          {
            value: "knapsack",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "knapsack", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border border-primary/15", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-4 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "🎒" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-lg text-primary", children: "Study Time Optimizer (0/1 Knapsack)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Choose which subjects to study to maximize total marks within a time limit." })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(KnapsackDemo, {}) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "lcs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border border-secondary/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-4 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "📝" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-lg text-secondary", children: "Notes Similarity Checker (LCS)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Find the longest matching content between two notes and get a similarity score." })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LcsDemo, {}) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "matrix", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border border-accent/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-4 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "📐" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-lg text-accent", children: "Study Order Optimizer (Matrix Chain)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Find the best order to tackle subjects to minimize total mental effort." })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MatrixChainDemo, {}) })
      ] }) })
    ] })
  ] }) });
}
...
function ComparisonSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-3 bg-muted text-muted-foreground border-border", children: "Comparison" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl font-bold mb-4", children: "Algorithms at a Glance" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-xl mx-auto", children: "Compare the three algorithms and understand when DP outshines plain recursion." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl mb-4", children: "📊 Algorithm Comparison" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto rounded-xl border bg-card shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/40", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold", children: "Algorithm" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold", children: "Real-Life Use" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold", children: "Time Complexity" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold", children: "Space Complexity" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold", children: "Efficiency" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: algoComparisonData.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                TableRow,
                {
                  className: "hover:bg-muted/20 transition-colors",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium", children: row.algo }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-muted-foreground", children: row.use }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "text-xs bg-primary/10 text-primary px-1.5 py-0.5 rounded", children: row.time }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "text-xs bg-accent/10 text-accent px-1.5 py-0.5 rounded", children: row.space }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { style: { color: "oklch(0.65 0.15 60)" }, children: row.efficiency })
                  ]
                },
                row.algo
              )) })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl mb-4", children: "⚔️ DP vs Plain Recursion" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto rounded-xl border bg-card shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/40", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold", children: "Metric" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold text-primary", children: "DP Approach" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold text-muted-foreground", children: "Plain Recursion" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: dpVsRecursion.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                TableRow,
                {
                  className: "hover:bg-muted/20 transition-colors",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium text-sm", children: row.metric }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm text-primary", children: row.dp }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm text-muted-foreground", children: row.recursion })
                  ]
                },
                row.metric
              )) })
...
function ConclusionSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      className: "py-20",
      style: {
        background: "linear-gradient(135deg, oklch(0.96 0.03 145) 0%, oklch(0.96 0.025 190) 50%, oklch(0.95 0.03 230) 100%)"
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-3 bg-secondary/15 text-secondary-foreground border-secondary/20", children: "Conclusion" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl font-bold mb-4", children: "Why Every Student Should Know DP" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-lg max-w-xl mx-auto", children: [
            ...
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "thinking framework" }),
            " for solving complex problems efficiently."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6 mb-10", children: conclusionBenefits.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Card,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: b.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h3",
                {
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 text-center space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground", children: "📚 Student Life Optimization System" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Demonstrating Dynamic Programming through real-life student problems — Knapsack · LCS · Matrix Chain" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
      "© ",
      year,
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AlgorithmsSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DemoSection, {}),
